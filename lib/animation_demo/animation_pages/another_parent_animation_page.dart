...
class ParentAnimation extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    ...
    return ParentAnimationState();
  }

}

class ParentAnimationState extends State<ParentAnimation> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (BuildContext context,Widget child){
        return Scaffold(
          body: Transform(transform: Matrix4.translationValues(parentAnimation.value*width, 0.0, 0.0),
          child: Center(
              child: Column(
