  ...
  Widget _buildButtonRow(BuildContext context){
    return Row(
      children: <Widget>[
        ...
        _buildButton(_rightButtonPressed,Colors.blueAccent,context,stopwatch.isRunning?Icons.pause:Icons.play_arrow),
      ],
    );
  }
...
class TimerText extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return TimerTextState(stopwatch: stopwatch);
  }
...
class TimerTextState extends State<TimerText> {
  ...
  Widget build(BuildContext context) {
    ...
    List<String> formatTime = TimerTextFormatter.format(stopwatch.elapsedMilliseconds);
    // TODO: implement build
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: <Widget>[
