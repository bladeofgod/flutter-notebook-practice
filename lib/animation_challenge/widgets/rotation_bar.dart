...
import 'dart:math';
import 'package:flutter_notebook_practice/animation_challenge/utils/rect_getter.dart';

typedef TouchCallBack = void Function(double r);
enum Style{Touch,Rotate}


class RotationBar extends StatefulWidget{
  ...
  final Style style;
  final bool goBackCenter;

  RotationBar({this.getAngle,@required this.dy,@required this.dx,this.style,this.goBackCenter});

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return new RotationBarState();
  }

}

class RotationBarState extends State<RotationBar> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(image: ExactAssetImage('assets/icon_control_ctrl_origin1.png'),
        fit: BoxFit.cover),
      ...
      child: RectGetter(
        ...
        child: Center(
          child: GestureDetector(
            ...
            //用户手离开之后触发，让小圆点回到中心
            onScaleEnd: (_)=>widget.goBackCenter != null?widget.goBackCenter?getBackCenter():{}:{},
            child: Container(
              constraints: BoxConstraints.tightFor(height: 200.0,width: 200.0),
              decoration: BoxDecoration(
                  ...
                  currentOffset != null ?
                      Positioned(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            shape: BoxShape.circle,
                            image: DecorationImage(image: ExactAssetImage('assets/icon_control_ctrl_origin.png'))
                          ),
                        ),),
                      )
                      :Container()
